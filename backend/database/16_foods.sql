...
('fd000021-0000-0000-0000-000000000021', 'Bún riêu cua', 'Vietnamese crab noodle soup', 'Món nước', 'Bún riêu cua đặc trưng miền Bắc với gạch cua và đậu rán', 380, 22.0, 48.0, 10.0, 2.5, 40000, 400, 'https://images.unsplash.com/photo-1625220194771-7ebedd0b40b8?w=400', true, now(), 'north'),
('fd000022-0000-0000-0000-000000000022', 'Bún thang', 'Hanoi bun thang', 'Món nước', 'Bún thang Hà Nội thanh đạm với trứng, gà xé, giò lụa', 360, 25.0, 42.0, 8.0, 1.5, 50000, 380, 'https://images.unsplash.com/photo-1596797038530-2c107229654b?w=400', true, now(), 'north'),
...
('fd000044-0000-0000-0000-000000000044', 'Cao lầu', 'Cao lau noodles', 'Món mặn', 'Cao lầu Hội An sợi mì dai vàng đặc trưng ăn với thịt xá xíu và rau sống', 480, 22.0, 58.0, 16.0, 2.5, 50000, 380, 'https://images.unsplash.com/photo-1596797038530-2c107229654b?w=400', true, now(), 'central'),
...
('fd000048-0000-0000-0000-000000000048', 'Bánh mì ốp la', 'Baguette with fried egg', 'Món sáng', 'Bánh mì Việt Nam kẹp trứng ốp la, pate và rau thơm', 420, 18.0, 45.0, 18.0, 2.0, 20000, 180, 'https://images.unsplash.com/photo-1509440159596-0249088772ff?w=400', true, now(), 'south'),
...
-- =============================================================================
-- MenuGreen Seed Data - Additional 20 Vietnamese dishes (Items 51-70)
-- Added to reach 150 food catalog coverage. Idempotent via Id.
-- Categories: Món nước, Món mặn, Món sáng, Snack, Tráng miệng, Thức uống, Tinh bột
-- =============================================================================
,('fd000051-0000-0000-0000-000000000051', 'Cơm chiên Dương Châu', 'Yangzhou fried rice', 'Món mặn', 'Cơm chiên Dương Châu với tôm, xúc xích, trứng và rau củ', 540, 22.0, 65.0, 18.0, 2.5, 40000, 350, 'https://images.unsplash.com/photo-1603133872878-684f208fb84b?w=400', true, now(), 'south')
,('fd000052-0000-0000-0000-000000000052', 'Lẩu Tomyum Thái', 'Thai tomyum hotpot', 'Món canh', 'Lẩu Tomyum chua cay đặc trưng Thái Lan với tôm và nấm', 280, 22.0, 12.0, 14.0, 3.0, 180000, 600, 'https://images.unsplash.com/photo-1547592166-23ac45744acd?w=400', true, now(), null)
,('fd000053-0000-0000-0000-000000000053', 'Bánh xèo miền Tây', 'Vietnamese crepe Mekong style', 'Món mặn', 'Bánh xèo miền Tây giòn vàng nhân tôm, thịt, giá đỗ', 420, 18.0, 42.0, 18.0, 2.5, 35000, 200, 'https://images.unsplash.com/photo-1569050467447-ce54b3bbc37d?w=400', true, now(), 'south')
,('fd000054-0000-0000-0000-000000000054', 'Bánh khọt Vũng Tàu', 'Vung Tau mini pancakes', 'Món mặn', 'Bánh khọt giòn nhỏ xinh nhân tôm và mỡ hành', 360, 14.0, 35.0, 18.0, 1.5, 30000, 150, 'https://images.unsplash.com/photo-1567620905732-2d1ec7ab7445?w=400', true, now(), 'south')
,('fd000055-0000-0000-0000-000000000055', 'Bánh ít ram', 'Sweet and savory ram cake', 'Snack', 'Bánh ít nhân tôm thịt bọc lá chuối chiên giòn', 280, 9.0, 42.0, 8.0, 1.5, 15000, 100, 'https://images.unsplash.com/photo-1589115018-17b7b3da4d3a?w=400', true, now(), 'central')
,('fd000056-0000-0000-0000-000000000056', 'Bánh bèo Huế', 'Hue steamed rice cakes', 'Snack', 'Bánh bèo Huế chén nhỏ phủ tôm chấy và mỡ hành', 250, 8.0, 45.0, 4.0, 1.0, 20000, 150, 'https://images.unsplash.com/photo-1589115018-17b7b3da4d3a?w=400', true, now(), 'central')
,('fd000057-0000-0000-0000-000000000057', 'Bánh nậm Huế', 'Hue folded leaf cake', 'Snack', 'Bánh nậm gói lá chuối nhân tôm thịt mộc nhĩ', 280, 10.0, 42.0, 7.0, 1.2, 25000, 150, 'https://images.unsplash.com/photo-1589115018-17b7b3da4d3a?w=400', true, now(), 'central')
,('fd000058-0000-0000-0000-000000000058', 'Bánh lọt nước cốt dừa', 'Banh lot coconut milk', 'Tráng miệng', 'Bánh lọt dai mát chan nước cốt dừa béo và đá', 220, 3.0, 38.0, 8.0, 1.0, 15000, 250, 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400', true, now(), 'south')
,('fd000059-0000-0000-0000-000000000059', 'Chè bưởi', 'Pomelo sweet soup', 'Tráng miệng', 'Chè bưởi giòn sần sật với đậu xanh và nước cốt dừa', 240, 5.0, 42.0, 6.0, 2.0, 15000, 200, 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400', true, now(), 'south')
,('fd000060-0000-0000-0000-000000000060', 'Sương sáo nước cốt dừa', 'Grass jelly with coconut milk', 'Tráng miệng', 'Sương sáo mát lạnh chan nước cốt dừa béo và đá', 180, 2.0, 30.0, 6.0, 1.5, 12000, 250, 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400', true, now(), null)
,('fd000061-0000-0000-0000-000000000061', 'Yaourt đá', 'Frozen yogurt drink', 'Thức uống', 'Yaourt đá mát lạnh vị chua ngọt dễ uống', 150, 4.0, 28.0, 3.0, 0.0, 15000, 250, 'https://images.unsplash.com/photo-1488900128323-21503983a07e?w=400', true, now(), null)
,('fd000062-0000-0000-0000-000000000062', 'Trà vải', 'Lychee iced tea', 'Thức uống', 'Trà vải thanh mát vị trái cây nhiệt đới', 120, 0.5, 28.0, 0.0, 0.5, 20000, 300, 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=400', true, now(), null)
,('fd000063-0000-0000-0000-000000000063', 'Sinh tố bơ', 'Avocado smoothie', 'Thức uống', 'Sinh tố bơ sáp béo ngậy thêm sữa đặc và đá xay', 320, 5.0, 32.0, 18.0, 6.0, 25000, 350, 'https://images.unsplash.com/photo-1553530666-ba11a7da3888?w=400', true, now(), null)
,('fd000064-0000-0000-0000-000000000064', 'Sinh tố dâu', 'Strawberry smoothie', 'Thức uống', 'Sinh tố dâu tây tươi với sữa chua và đá xay', 220, 5.0, 42.0, 4.0, 3.0, 28000, 350, 'https://images.unsplash.com/photo-1488900128323-21503983a07e?w=400', true, now(), null)
,('fd000065-0000-0000-0000-000000000065', 'Cà phê trứng Hà Nội', 'Hanoi egg coffee', 'Thức uống', 'Cà phê trứng béo ngậy đặc sản phố cổ Hà Nội', 250, 6.0, 22.0, 15.0, 0.0, 30000, 180, 'https://images.unsplash.com/photo-1461023058943-07fcbe16d735?w=400', true, now(), 'north')
,('fd000066-0000-0000-0000-000000000066', 'Bánh chưng Tết', 'Vietnamese square sticky rice cake', 'Tinh bột', 'Bánh chưng truyền thống Tết Nguyên Đán nhân đỗ xanh thịt heo', 480, 18.0, 60.0, 18.0, 3.0, 60000, 300, 'https://images.unsplash.com/photo-1589115018-17b7b3da4d3a?w=400', true, now(), 'north')
,('fd000067-0000-0000-0000-000000000067', 'Bánh tét Tết', 'Vietnamese cylindrical sticky rice cake', 'Tinh bột', 'Bánh tét miền Trung nhân chuối và đậu xanh', 420, 14.0, 60.0, 12.0, 3.0, 50000, 250, 'https://images.unsplash.com/photo-1589115018-17b7b3da4d3a?w=400', true, now(), 'central')
,('fd000068-0000-0000-0000-000000000068', 'Bánh ít nhân dừa', 'Sweet sticky rice cake with coconut', 'Tráng miệng', 'Bánh ít nhân dừa tươi bọc lá chuối hấp dẻo', 280, 5.0, 50.0, 7.0, 2.0, 15000, 100, 'https://images.unsplash.com/photo-1589115018-17b7b3da4d3a?w=400', true, now(), 'central')
,('fd000069-0000-0000-0000-000000000069', 'Bánh da lợn', 'Vietnamese layered pandan cake', 'Tráng miệng', 'Bánh da lợn nhiều lớp lá dứa và đậu xanh', 260, 5.0, 45.0, 7.0, 1.5, 15000, 150, 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400', true, now(), null)
,('fd000070-0000-0000-0000-000000000070', 'Bánh bò Thốt Nốt', 'Palm sugar rice cake', 'Tráng miệng', 'Bánh bò Thốt Nốt ngọt thanh hương đường thốt nốt miền Tây', 280, 4.0, 52.0, 5.0, 1.0, 12000, 150, 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400', true, now(), 'south')
