...
,('ec000011-0000-0000-0000-000000000011', NULL, 'Trứng khoai lang áp chảo', 'Bữa sáng nhanh với trứng và khoai lang, phù hợp chuẩn bị từ tối hôm trước.', 10, 15, 25, 1, 'Easy', 'Breakfast', 18000, '[]', NULL, NULL, true, now())
,('ec000012-0000-0000-0000-000000000012', NULL, 'Yến mạch chuối sữa', 'Yến mạch ngâm cùng chuối và sữa, tiện mang đến văn phòng.', 5, 5, 10, 1, 'Easy', 'Breakfast', 22000, '[]', NULL, NULL, true, now())
,('ec000013-0000-0000-0000-000000000013', NULL, 'Bò xào nấm đùi gà', 'Thịt bò xào nấm nhanh gọn cho cơm hộp.', 10, 12, 22, 1, 'Easy', 'Lunch', 65000, '[]', NULL, NULL, true, now())
,('ec000014-0000-0000-0000-000000000014', NULL, 'Cơm gạo lứt ức gà bông cải', 'Cơm hộp cân bằng đạm, tinh bột và rau xanh.', 15, 25, 40, 1, 'Easy', 'Lunch', 48000, '[]', NULL, NULL, true, now())
,('ec000015-0000-0000-0000-000000000015', NULL, 'Đậu hũ sốt nấm cà chua', 'Bữa tối nhẹ, dễ nấu sau giờ làm.', 10, 15, 25, 1, 'Easy', 'Dinner', 28000, '[]', NULL, NULL, true, now())
,('ec000016-0000-0000-0000-000000000016', NULL, 'Salad trứng bơ', 'Salad trứng và bơ đủ chất cho bữa tối nhanh.', 10, 10, 20, 1, 'Easy', 'Dinner', 32000, '[]', NULL, NULL, true, now())
