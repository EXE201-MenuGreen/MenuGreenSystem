-- Add the standalone Casual package without recreating subscription tables.
...
INSERT INTO micro_learning_cards (
    "Id", "Title", "Summary", "Category", "Tips", "ImageUrl",
    "QuizQuestion", "QuizOptions", "CorrectOptionIndex", "PointsReward",
    "IsActive", "CreatedAt"
)
VALUES (
