    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_coach_chat_messages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_coach_chat_messages_users_ReceiverId",
                        column: x => x.ReceiverId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_coach_chat_messages_users_SenderId",
                        column: x => x.SenderId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProposalType = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    Status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                    PeriodStart = table.Column<DateOnly>(type: "date", nullable: false),
                    PeriodEnd = table.Column<DateOnly>(type: "date", nullable: false),
                    ExpiresAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    SourcePlanVersion = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_meal_plan_proposals", x => x.Id);
                    table.ForeignKey(
                        name: "FK_meal_plan_proposals_PtReviewRequests_ReviewRequestId",
                        column: x => x.ReviewRequestId,
                        principalTable: "PtReviewRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_meal_plan_proposals_users_CoachId",
                        column: x => x.CoachId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_meal_plan_proposals_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExistingMealPlanItemId = table.Column<Guid>(type: "uuid", nullable: true),
                    FoodId = table.Column<Guid>(type: "uuid", nullable: true),
                    RecipeId = table.Column<Guid>(type: "uuid", nullable: true),
                    QuantityG = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: true),
                    TargetCalories = table.Column<int>(type: "integer", nullable: true),
                    SortOrder = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_meal_plan_proposal_items", x => x.Id);
                    table.ForeignKey(
                        name: "FK_meal_plan_proposal_items_foods_FoodId",
                        column: x => x.FoodId,
                        principalTable: "foods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_meal_plan_proposal_items_meal_plan_items_ExistingMealPlanIt~",
                        column: x => x.ExistingMealPlanItemId,
                        principalTable: "meal_plan_items",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_meal_plan_proposal_items_meal_plan_proposals_ProposalId",
                        column: x => x.ProposalId,
                        principalTable: "meal_plan_proposals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_meal_plan_proposal_items_recipes_RecipeId",
                        column: x => x.RecipeId,
                        principalTable: "recipes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_coach_chat_messages_ReceiverId_ReadAt",
                table: "coach_chat_messages",
                columns: new[] { "ReceiverId", "ReadAt" });

            migrationBuilder.CreateIndex(
                name: "IX_coach_chat_messages_SenderId_ReceiverId_SentAt",
                table: "coach_chat_messages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_meal_plan_headers_Status",
                table: "meal_plan_headers",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_meal_plan_proposal_items_ExistingMealPlanItemId",
                table: "meal_plan_proposal_items",
                column: "ExistingMealPlanItemId");

            migrationBuilder.CreateIndex(
                name: "IX_meal_plan_proposal_items_FoodId",
                table: "meal_plan_proposal_items",
                column: "FoodId");

            migrationBuilder.CreateIndex(
                name: "IX_meal_plan_proposal_items_PlannedDate",
                table: "meal_plan_proposal_items",
                column: "PlannedDate");

            migrationBuilder.CreateIndex(
                name: "IX_meal_plan_proposal_items_ProposalId",
                table: "meal_plan_proposal_items",
                column: "ProposalId");

            migrationBuilder.CreateIndex(
                name: "IX_meal_plan_proposal_items_RecipeId",
                table: "meal_plan_proposal_items",
                column: "RecipeId");

            migrationBuilder.CreateIndex(
                name: "IX_meal_plan_proposals_CoachId",
                table: "meal_plan_proposals",
                column: "CoachId");

            migrationBuilder.CreateIndex(
                name: "IX_meal_plan_proposals_ReviewRequestId_ProposalType",
                table: "meal_plan_proposals",
                columns: new[] { "ReviewRequestId", "ProposalType" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_meal_plan_proposals_Status_ExpiresAt",
                table: "meal_plan_proposals",
                columns: new[] { "Status", "ExpiresAt" });

            migrationBuilder.CreateIndex(
                name: "IX_meal_plan_proposals_UserId",
                table: "meal_plan_proposals",
                column: "UserId");
