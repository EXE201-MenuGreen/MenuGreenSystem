...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MenuGreen.DataAccessLayer.Entities.MealPlanProposal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("SourcePlanVersion")
                        .HasColumnType("timestamp with time zone");
                    ...
                    b.HasIndex("ReviewRequestId", "ProposalType")
                        .IsUnique();

                    b.HasIndex("Status", "ExpiresAt");

                    b.ToTable("meal_plan_proposals", (string)null);
                });

            modelBuilder.Entity("MenuGreen.DataAccessLayer.Entities.MealPlanProposalItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("ExistingMealPlanItemId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ExistingMealPlanItemId");
                    ...
                    b.ToTable("meal_plan_proposal_items", (string)null);
                });
            ...
            modelBuilder.Entity("MenuGreen.DataAccessLayer.Entities.MealPlanProposal", b =>
                {
                    ...
                    b.HasOne("MenuGreen.DataAccessLayer.Entities.PtReviewRequest", "ReviewRequest")
                        .WithMany()
            ...
            modelBuilder.Entity("MenuGreen.DataAccessLayer.Entities.MealPlanProposalItem", b =>
                {
                    b.HasOne("MenuGreen.DataAccessLayer.Entities.MealPlanItem", "ExistingMealPlanItem")
                        .WithMany()
                        .HasForeignKey("ExistingMealPlanItemId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.HasOne("MenuGreen.DataAccessLayer.Entities.MealPlanProposal", "Proposal")
                        .WithMany("Items")
                    ...
                    b.Navigation("ExistingMealPlanItem");
