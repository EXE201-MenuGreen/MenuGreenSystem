...
class ApiMessageTranslator {
  ...
  static const _exact = <String, String>{
    ...
    'If the email exists, an OTP has been sent.':
        'Nếu email tồn tại, mã OTP đã được gửi đến bạn.',
    'You do not have permission to edit this custom unit.':
        'Bạn không có quyền chỉnh sửa đơn vị tùy chỉnh này.',
    'Coach application not found.':
        'Không tìm thấy đơn đăng ký Huấn luyện viên.',
    'Client does not exist.': 'Khách hàng không tồn tại.',
    'Default serving weight must be greater than 0 grams.':
        'Khối lượng phục vụ mặc định phải lớn hơn 0 gam.',
    ...
    'The Basic plan is always available and does not require renewal.':
        'Gói Basic luôn có sẵn và không yêu cầu gia hạn.',
    'Conversation not found.': 'Không tìm thấy cuộc trò chuyện.',
    'Budget configuration deleted successfully.':
        'Đã xóa cấu hình ngân sách thành công.',
    'Meal template must contain at least one item.':
        'Mẫu bữa ăn phải chứa ít nhất một mục.',
    'Original ingredient quantity must be greater than 0.':
        'Số lượng nguyên liệu gốc phải lớn hơn 0.',
    'Student has not set up their health profile.':
        'Học viên chưa thiết lập hồ sơ sức khỏe.',
    'This meal plan was sent to another coach.':
        'Kế hoạch bữa ăn này đã được gửi cho một huấn luyện viên khác.',
    'Food log not found.': 'Không tìm thấy nhật ký món ăn.',
    'Each meal plan item must have either FoodId, RecipeId, or CustomName.':
        'Mỗi mục kế hoạch bữa ăn phải có FoodId, RecipeId hoặc Tên tùy chỉnh.',
    'Account type must be User or PT.':
        'Loại tài khoản phải là Người dùng hoặc PT.',
    'Internal server error.': 'Lỗi máy chủ nội bộ.',
    'Payment order cancelled successfully.':
        'Đã hủy đơn hàng thanh toán thành công.',
    'You already have a pending SePay payment. Complete or wait for it to expire before creating a new order.':
        'Bạn đang có một khoản thanh toán SePay chờ xử lý. Hoàn thành hoặc đợi hết hạn trước khi tạo đơn hàng mới.',
    'Conversation deleted successfully.': 'Đã xóa cuộc trò chuyện thành công.',
    'User premium program registration not found.':
        'Không tìm thấy đăng ký chương trình Premium của người dùng.',
    ...
    'JwtSettings:SecretKey is not configured.':
        'JwtSettings:SecretKey chưa được cấu hình.',
    'PriceVnd must be greater than or equal to 0.':
        'Giá VNĐ phải lớn hơn hoặc bằng 0.',
    ...
    'At least one professional certificate is required.':
        'Cần ít nhất một chứng chỉ chuyên môn.',
    ...
    'Snooze duration must be between 1 and 1440 minutes.':
        'Thời gian báo lại phải từ 1 đến 1440 phút.',
    'Empty webhook body.': 'Nội dung webhook trống.',
    'Your nutrition data is stable, no goal drift detected.':
        'Dữ liệu dinh dưỡng của bạn ổn định, không phát hiện sai lệch mục tiêu.',
    ...
    'This plan is free and cannot be renewed via SePay.':
        'Gói này miễn phí và không thể gia hạn qua SePay.',
    'Name is required.': 'Tên là bắt buộc.',
    'Coach profile not found.': 'Không tìm thấy hồ sơ huấn luyện viên.',
    'Biography must contain at least 80 characters.':
        'Tiểu sử phải chứa ít nhất 80 ký tự.',
    'FoodId or RecipeId or custom nutritional values are required.':
        'Yêu cầu có FoodId, RecipeId hoặc giá trị dinh dưỡng tùy chỉnh.',
    'Food is inactive and cannot be added to favorites.':
        'Món ăn không hoạt động và không thể thêm vào mục yêu thích.',
    'Report not found.': 'Không tìm thấy báo cáo.',
    'No current goal drift alert.':
        'Không có cảnh báo sai lệch mục tiêu hiện tại.',
    'Password changed successfully.': 'Đổi mật khẩu thành công.',
    'SePay webhook request expired.': 'Yêu cầu webhook SePay đã hết hạn.',
    'Hip measurement must be between 30cm and 250cm.':
        'Số đo vòng hông phải từ 30cm đến 250cm.',
    'ConnectionStrings__DefaultConnection environment variable is not configured.':
        'Biến môi trường ConnectionStrings__DefaultConnection chưa được cấu hình.',
    'NotificationIds list cannot be empty':
        'Danh sách NotificationIds không được để trống.',
    'Please enter your date of birth in your profile first to calculate targets.':
        'Vui lòng nhập ngày sinh trong hồ sơ của bạn trước để tính toán mục tiêu.',
    'You do not have a valid coaching connection with this student.':
        'Bạn không có kết nối huấn luyện hợp lệ với học viên này.',
    "You do not have access to this student's feedback.":
        'Bạn không có quyền truy cập vào phản hồi của học viên này.',
    'Program enrollment not found.': 'Không tìm thấy đăng ký chương trình.',
    'This meal plan does not belong to the specified student.':
        'Kế hoạch bữa ăn này không thuộc về học viên được chỉ định.',
    'You do not have any active Premium programs.':
        'Bạn không có chương trình Premium nào đang hoạt động.',
    'Requested food/dish not found.':
        'Không tìm thấy món ăn/thực phẩm yêu cầu.',
    'AI service did not return a job ID.':
        'Dịch vụ AI không trả về ID công việc.',
    'This program has not been paid for or is already activated.':
        'Chương trình này chưa được thanh toán hoặc đã được kích hoạt.',
    ...
    'Equivalent weight must be between 0.1g and 10000g.':
        'Trọng lượng tương đương phải từ 0.1g đến 10000g.',
    ...
    'A reason is required for this decision.':
        'Cần có lý do cho quyết định này.',
    ...
    'Data access granted to Coach.':
        'Đã cấp quyền truy cập dữ liệu cho Huấn luyện viên.',
    ...
    'Reminder time must be in the future.':
        'Thời gian nhắc nhở phải ở trong tương lai.',
    ...
    'DurationDays must be greater than or equal to 0.':
        'DurationDays phải lớn hơn hoặc bằng 0.',
    'Google sign-in is not configured on the server.':
        'Đăng nhập Google chưa được cấu hình trên máy chủ.',
    'FoodId is required when converting a local portion unit.':
        'FoodId là bắt buộc khi chuyển đổi đơn vị khẩu phần cục bộ.',
    'Avatar URL must be a valid URL.':
        'URL hình đại diện phải là một URL hợp lệ.',
    'Notification deleted successfully.': 'Đã xóa thông báo thành công.',
    'Only active subscriptions can be renewed via SePay.':
        'Chỉ các gói đăng ký đang hoạt động mới có thể được gia hạn qua SePay.',
    'Weight must be between 30kg and 300kg.':
        'Cân nặng phải từ 30kg đến 300kg.',
    'The Basic plan is enabled by default and does not require a subscription.':
        'Gói Basic được kích hoạt mặc định và không yêu cầu đăng ký.',
    'Substitute ingredient not found.': 'Không tìm thấy nguyên liệu thay thế.',
    'Cooking time limit must be between 5 minutes and 1,440 minutes.':
        'Giới hạn thời gian nấu phải từ 5 phút đến 1.440 phút.',
    'City is required.': 'Thành phố là bắt buộc.',
    'The application is already being reviewed.':
        'Đơn đăng ký đang được xem xét.',
    'The image analysis task timed out on the AI service.':
        'Nhiệm vụ phân tích hình ảnh đã quá thời gian trên dịch vụ AI.',
    'At least one language is required.': 'Cần ít nhất một ngôn ngữ.',
    'SePay payment not found.': 'Không tìm thấy khoản thanh toán SePay.',
    'CV service is not properly configured.':
        'Dịch vụ CV chưa được cấu hình đúng.',
    'You do not have permission to delete this custom unit.':
        'Bạn không có quyền xóa đơn vị tùy chỉnh này.',
    'Registration successful. Please check your email for the verification OTP.':
        'Đăng ký thành công. Vui lòng kiểm tra email của bạn để lấy mã xác minh OTP.',
    'Image file is required.': 'Tệp hình ảnh là bắt buộc.',
    'Default serving weight is required.':
        'Khối lượng phục vụ mặc định là bắt buộc.',
    'Substitute ingredient quantity must be greater than 0.':
        'Số lượng nguyên liệu thay thế phải lớn hơn 0.',
    'Connection with this coach not found.':
        'Không tìm thấy kết nối với huấn luyện viên này.',
    'This report has already been reviewed or closed.':
        'Báo cáo này đã được đánh giá hoặc đóng lại.',
    'Missing X-SePay-Signature header.': 'Thiếu tiêu đề X-SePay-Signature.',
    'OTP code must be at least 6 characters long.':
        'Mã OTP phải dài ít nhất 6 ký tự.',
    'At least one specialty is required.': 'Cần ít nhất một chuyên môn.',
    'Invalid payment status. Please refresh and try again.':
        'Trạng thái thanh toán không hợp lệ. Vui lòng làm mới và thử lại.',
    'SePay bank account is not configured. Set SePay:BankAccount:AccountNumber and SePay:BankAccount:BankName in appsettings (values from your SePay dashboard).':
        'Tài khoản ngân hàng SePay chưa được cấu hình.',
    'Phone number is required.': 'Số điện thoại là bắt buộc.',
    'Substitution configuration not found.':
        'Không tìm thấy cấu hình thay thế.',
    'Token removed successfully.': 'Đã xóa token thành công.',
    'Active connection with this coach not found.':
        'Không tìm thấy kết nối hoạt động với huấn luyện viên này.',
    ...
    'Reminder notification sent successfully.':
        'Đã gửi thông báo nhắc nhở thành công.',
    'You do not have an active Premium program to get report from.':
        'Bạn không có chương trình Premium nào đang hoạt động để lấy báo cáo.',
    'This micro-learning card does not have an attached quiz question.':
        'Thẻ học tập vi mô này không có câu hỏi trắc nghiệm đính kèm.',
    'Invalid SePay webhook API key.': 'Khóa API webhook SePay không hợp lệ.',
    'AI service rejected the API key. Please contact support.':
        'Dịch vụ AI đã từ chối khóa API. Vui lòng liên hệ hỗ trợ.',
    'The application is being reviewed and cannot be edited.':
        'Đơn đăng ký đang được xem xét và không thể chỉnh sửa.',
    'This token is already registered by another user.':
        'Token này đã được đăng ký bởi một người dùng khác.',
    'Campaign not found.': 'Không tìm thấy chiến dịch.',
    'Unit name is required.': 'Tên đơn vị là bắt buộc.',
    'Your issue report has been successfully recorded.':
        'Báo cáo sự cố của bạn đã được ghi nhận thành công.',
    ...
    'Receiver bank account in webhook does not match configured SePay bank account.':
        'Tài khoản ngân hàng người nhận trong webhook không khớp với tài khoản SePay đã cấu hình.',
    'Meal in meal plan not found.': 'Không tìm thấy bữa ăn trong kế hoạch.',
    'SePay:WebhookSecret is not configured.':
    ...
    'Subscription program registration details not found.':
        'Không tìm thấy chi tiết đăng ký chương trình.',
    "Invalid action. Only 'read', 'save', 'unsave', 'dismiss' are accepted.":
        "Hành động không hợp lệ. Chỉ chấp nhận 'read', 'save', 'unsave', 'dismiss'.",
    'Weight must be between 20kg and 500kg.':
        'Cân nặng phải từ 20kg đến 500kg.',
    'Unsupported AI action type.': 'Loại hành động AI không được hỗ trợ.',
    'New password is required.': 'Mật khẩu mới là bắt buộc.',
    'SePay:WebhookApiKey is not configured.':
        'SePay:WebhookApiKey chưa được cấu hình.',
    'You need to graduate before exporting the certificate.':
        'Bạn cần hoàn thành chương trình trước khi xuất chứng chỉ.',
    ...
    'Conversion quantity must be between 0.01 and 1000.':
        'Số lượng chuyển đổi phải từ 0.01 đến 1000.',
    'Budget request not found.': 'Không tìm thấy yêu cầu ngân sách.',
    'Food ID is required.': 'Food ID là bắt buộc.',
    'budget_vnd is required for budget optimization.':
        'budget_vnd là bắt buộc để tối ưu hóa ngân sách.',
    'weekStart must be yyyy-MM-dd.': 'weekStart phải có định dạng yyyy-MM-dd.',
    'Duplicate transaction ignored (database constraint).':
        'Giao dịch trùng lặp bị bỏ qua (ràng buộc cơ sở dữ liệu).',
    'Unit name cannot exceed 150 characters.':
        'Tên đơn vị không được vượt quá 150 ký tự.',
    'New password must be at least 6 characters long.':
        'Mật khẩu mới phải dài ít nhất 6 ký tự.',
    'Carbs must be positive.': 'Carbs phải là số dương.',
    'Target body fat percentage must be between 1% and 80%.':
        'Tỷ lệ mỡ cơ thể mục tiêu phải từ 1% đến 80%.',
    'Student or Coach does not exist.':
        'Học viên hoặc Huấn luyện viên không tồn tại.',
    'Budget must be between 1,000 VND and 100,000,000 VND.':
        'Ngân sách phải từ 1.000 VNĐ đến 100.000.000 VNĐ.',
    'Transfer content does not contain a valid payment code.':
        'Nội dung chuyển khoản không chứa mã thanh toán hợp lệ.',
    'Meal template not found.': 'Không tìm thấy mẫu bữa ăn.',
    'Missing or invalid Authorization Apikey header.':
        'Thiếu tiêu đề Authorization Apikey hoặc không hợp lệ.',
    'Invalid year.': 'Năm không hợp lệ.',
    'You need to check in for all weeks to graduate from the program.':
        'Bạn cần check-in cho tất cả các tuần để hoàn thành chương trình.',
    'DefaultConnection is not configured.':
        'DefaultConnection chưa được cấu hình.',
    'Cannot cancel a payment that has already been paid.':
        'Không thể hủy khoản thanh toán đã được trả.',
    ...
    'Dinner time must be in HH:mm format.':
        'Thời gian bữa tối phải ở định dạng HH:mm.',
    ...
    'food_id or recipe_id is required to schedule a meal.':
        'Cần có food_id hoặc recipe_id để lên lịch bữa ăn.',
    'Missing or invalid X-SePay-Timestamp header.':
        'Thiếu tiêu đề X-SePay-Timestamp hoặc không hợp lệ.',
    'Alerts are derived from meal plan compare and tracking data.':
        'Cảnh báo được tạo từ so sánh kế hoạch bữa ăn và dữ liệu theo dõi.',
    'quantity_g or quantity is required to log a meal.':
        'Bắt buộc có quantity_g hoặc quantity để ghi lại bữa ăn.',
    'Recommendation history deleted successfully.':
        'Đã xóa lịch sử gợi ý thành công.',
    ...
    'The coach account is suspended.':
        'Tài khoản huấn luyện viên đã bị đình chỉ.',
    'Only SePay payments can be cancelled via this endpoint.':
        'Chỉ các khoản thanh toán SePay mới có thể bị hủy qua endpoint này.',
    'Your account has been locked.': 'Tài khoản của bạn đã bị khóa.',
    'Webhook processed successfully.': 'Đã xử lý webhook thành công.',
    'Date of birth is required to calculate your profile and target metrics.':
        'Cần ngày sinh để tính toán hồ sơ và số đo mục tiêu của bạn.',
    'This plan is free. Use POST /api/UserSubscription/subscribe instead.':
        'Gói này miễn phí. Vui lòng sử dụng đăng ký gói miễn phí.',
    'Waist measurement must be between 30cm and 250cm.':
        'Số đo vòng eo phải từ 30cm đến 250cm.',
    'Could not generate a unique SePay payment code. Please try again.':
        'Không thể tạo mã thanh toán SePay duy nhất. Vui lòng thử lại.',
    'No active device tokens found.':
        'Không tìm thấy token thiết bị nào đang hoạt động.',
    'Specialty field is required.': 'Trường chuyên môn là bắt buộc.',
    'No active device tokens found for user.':
        'Không tìm thấy token thiết bị hoạt động cho người dùng.',
    'Password recovery OTP has been sent to your email.':
        'Mã OTP khôi phục mật khẩu đã được gửi đến email của bạn.',
    'Chest measurement must be between 30cm and 250cm.':
        'Số đo vòng ngực phải từ 30cm đến 250cm.',
    ...
    'AI Coach session deleted successfully.':
        'Đã xóa phiên AI Coach thành công.',
    'You do not have any active Premium program.':
        'Bạn không có chương trình Premium nào đang hoạt động.',
    'QuantityG or Quantity must be greater than 0.': 'Số lượng phải lớn hơn 0.',
    'You have already completed this quiz question.':
        'Bạn đã hoàn thành câu hỏi trắc nghiệm này.',
    "You do not have access to this student's reports.":
        'Bạn không có quyền truy cập vào các báo cáo của học viên này.',
    'Height must be between 50cm and 300cm.':
        'Chiều cao phải từ 50cm đến 300cm.',
    'Coach data access revoked.':
        'Quyền truy cập dữ liệu của huấn luyện viên đã bị thu hồi.',
    'Worker response is empty.': 'Phản hồi từ Worker trống.',
    'AI service returned an empty status response.':
        'Dịch vụ AI trả về trạng thái trống.',
    'Your account has been successfully deactivated per Google Play privacy and data deletion policy.':
        'Tài khoản của bạn đã bị vô hiệu hóa thành công theo chính sách bảo mật của Google Play.',
    'Invalid SePay transaction id.': 'ID giao dịch SePay không hợp lệ.',
    'Allergy not found.': 'Không tìm thấy dữ liệu dị ứng.',
    'Requested custom unit not found.':
        'Không tìm thấy đơn vị tùy chỉnh yêu cầu.',
    'Activity log not found.': 'Không tìm thấy nhật ký hoạt động.',
    'Body fat percentage must be between 1% and 80%.':
        'Tỷ lệ mỡ cơ thể phải từ 1% đến 80%.',
    'Successfully disconnected from Coach.':
        'Đã ngắt kết nối thành công với Huấn luyện viên.',
    ...
    'Certificate name, issuer and image are required.':
        'Tên chứng chỉ, tổ chức cấp và hình ảnh là bắt buộc.',
    'Removed from favorites successfully.':
        'Đã xóa khỏi mục yêu thích thành công.',
    'Provider order code is required.':
        'Mã đơn hàng của nhà cung cấp là bắt buộc.',
    'Student has not granted you access to their health data.':
        'Học viên chưa cấp cho bạn quyền truy cập vào dữ liệu sức khỏe của họ.',
    'You do not have permission to access this report.':
        'Bạn không có quyền truy cập vào báo cáo này.',
    ...
    'At least one portfolio image is required.':
        'Cần ít nhất một hình ảnh hồ sơ năng lực.',
    ...
    'Connection request sent to Coach.':
        'Đã gửi yêu cầu kết nối đến Huấn luyện viên.',
    'Invalid or expired refresh token.':
        'Token làm mới không hợp lệ hoặc đã hết hạn.',
    'Target weight must be between 30kg and 300kg.':
        'Cân nặng mục tiêu phải từ 30kg đến 300kg.',
    ...
    'Invalid month (must be between 1 and 12).':
        'Tháng không hợp lệ (phải từ 1 đến 12).',
    'Weight is required.': 'Cân nặng là bắt buộc.',
    'This report was sent to another coach.':
        'Báo cáo này đã được gửi cho một huấn luyện viên khác.',
    "Food applied to today's meal plan successfully.":
        'Đã áp dụng món ăn vào kế hoạch hôm nay thành công.',
    'Breakfast time must be in HH:mm format.':
        'Thời gian bữa sáng phải ở định dạng HH:mm.',
    'MealType must be Breakfast, Lunch, Dinner, or Snack.':
        'Loại bữa ăn phải là Sáng, Trưa, Tối hoặc Ăn vặt.',
    'Fat must be positive.': 'Chất béo (Fat) phải là số dương.',
    'Professional headline is required.':
        'Tiêu đề hồ sơ chuyên gia là bắt buộc.',
    'Paid subscriptions must use SePay. Subscribe: POST /api/payments/sepay/create-order. Renew: POST /api/payments/sepay/create-renew-order.':
        'Đăng ký trả phí phải sử dụng SePay.',
    'You have an active Premium program. Please complete your current program before starting a new one.':
        'Bạn có một chương trình Premium đang hoạt động. Vui lòng hoàn thành chương trình hiện tại trước khi bắt đầu chương trình mới.',
    'Review submitted. Student has been notified.':
        'Đã gửi đánh giá. Học viên đã được thông báo.',
    'Invalid SePay webhook payload.': 'Dữ liệu webhook SePay không hợp lệ.',
    'Lunch time must be in HH:mm format.':
        'Thời gian bữa trưa phải ở định dạng HH:mm.',
    ...
    'Each template item must reference Food/Recipe or contain an AI scan snapshot.':
        'Mỗi mục mẫu phải liên kết đến Món ăn/Công thức hoặc chứa ảnh AI Scan.',
    'Email does not exist.': 'Email không tồn tại.',
    'Date of birth is required.': 'Ngày sinh là bắt buộc.',
    'Firebase is not initialized. Check Firebase credential configuration.':
    ...
    'This request is not a mid-week or final weekly report.':
        'Đây không phải là báo cáo giữa tuần hoặc cuối tuần.',
    'Invalid or missing user identity in token.':
        'Danh tính người dùng trong token bị thiếu hoặc không hợp lệ.',
    'Amount must be greater than zero.': 'Số tiền phải lớn hơn 0.',
    'Payment order not found.': 'Không tìm thấy đơn hàng thanh toán.',
    'An identity verification image is required.':
        'Cần có hình ảnh xác minh danh tính.',
    'Job not found.': 'Không tìm thấy công việc.',
    'Please verify your OTP before logging in.':
        'Vui lòng xác minh mã OTP của bạn trước khi đăng nhập.',
    'Message not found.': 'Không tìm thấy tin nhắn.',
    'Original program details not found.':
        'Không tìm thấy chi tiết chương trình gốc.',
    'No budget configuration found.': 'Không tìm thấy cấu hình ngân sách.',
    'Feedback type is required.': 'Loại phản hồi là bắt buộc.',
    'Payment order not found by transfer content.':
        'Không tìm thấy đơn hàng thanh toán theo nội dung chuyển khoản.',
    ...
    'Action requires user confirmation.':
        'Thao tác yêu cầu sự xác nhận của người dùng.',
    'This action type is reserved for the next implementation phase.':
        'Loại thao tác này được dành riêng cho giai đoạn tiếp theo.',
    'Cannot create feedback event': 'Không thể tạo sự kiện phản hồi',
    'input_text and expected_output are required':
        'input_text và expected_output là bắt buộc',
  ...
  static String translateNotification(String? text) {
    ...
    final dynamic = _translateDynamicNotification(trimmed);
  ...
  static String? _translateDynamicNotification(String text) {
    final connectionRequest = RegExp(
      r'^(.+) wants to connect and hire you as their nutrition coach\.$',
    ).firstMatch(text);
    if (connectionRequest != null) {
      return '${connectionRequest.group(1)} muốn kết nối và thuê bạn làm PT dinh dưỡng.';
    }

    final connectionResponse = RegExp(
      r'^Coach (.+) has (accepted|rejected) your connection request\.$',
    ).firstMatch(text);
    if (connectionResponse != null) {
      final action = connectionResponse.group(2) == 'accepted'
          ? 'chấp nhận'
          : 'từ chối';
      return 'PT ${connectionResponse.group(1)} đã $action yêu cầu kết nối của bạn.';
    }

    final feedback = RegExp(
      r'^Coach (.+) sent you new feedback: "(.*)"$',
    ).firstMatch(text);
    if (feedback != null) {
      return 'PT ${feedback.group(1)} đã gửi phản hồi mới: "${feedback.group(2)}"';
    }

    final mealPlan = RegExp(
      r'^Coach (.+) has directly adjusted your meal plan\.$',
    ).firstMatch(text);
    if (mealPlan != null) {
      return 'PT ${mealPlan.group(1)} đã trực tiếp điều chỉnh kế hoạch ăn uống của bạn.';
    }

    final targets = RegExp(
      r'^Coach (.+) has updated your Calorie/Macros targets\.$',
    ).firstMatch(text);
    if (targets != null) {
      return 'PT ${targets.group(1)} đã cập nhật mục tiêu calo và dinh dưỡng của bạn.';
    }
