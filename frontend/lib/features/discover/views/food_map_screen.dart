...
class _FoodMapScreenState extends State<FoodMapScreen> {
      ...
      if (response.statusCode == 200 && response.body.isNotEmpty) {
        ...
        if (data is Map<String, dynamic>) {
          ...
          if (address is Map<String, dynamic>) {
            ...
            if (ward.isNotEmpty && !parts.contains(ward)) parts.add(ward);
            if (district.isNotEmpty && !parts.contains(district)) parts.add(district);
            if (city.isNotEmpty && !parts.contains(city) && !district.contains(city)) parts.add(city);
  ...
  void _generateNearbyFoodPins(double lat, double lng) {
    final isThuDucOrQ9 = lat >= 10.74 && lat <= 10.92 && lng >= 106.70 && lng <= 106.88;
    final isHanoi = lat >= 20.5 && lat <= 21.5 && lng >= 105.3 && lng <= 106.3;

    final seedData = isThuDucOrQ9
        ? [
            (name: 'Quán Lemon - Healthy & Drinks', calories: 280, p: 28, c: 22, f: 8, meal: 'LUNCH', icon: Icons.eco_rounded, dist: 50, address: 'Quán Lemon, Đường Lê Văn Việt, Quận 9, TP. Thủ Đức'),
            (name: 'Phở Bò Nam Định - Lê Văn Việt', calories: 450, p: 26, c: 55, f: 12, meal: 'BREAKFAST', icon: Icons.ramen_dining_rounded, dist: 180, address: '124 Lê Văn Việt, Phường Hiệp Phú, Quận 9, TP. Thủ Đức'),
            (name: 'Cơm Tấm Sườn Bì Chả Vincom Q9', calories: 620, p: 34, c: 72, f: 22, meal: 'LUNCH', icon: Icons.rice_bowl_rounded, dist: 320, address: 'Vincom Plaza Lê Văn Việt, Quận 9, TP. Thủ Đức'),
            (name: 'Hủ Tiếu Nam Vang Thành Đạt', calories: 510, p: 28, c: 60, f: 16, meal: 'LUNCH', icon: Icons.soup_kitchen_rounded, dist: 450, address: '215 Lê Văn Việt, Tăng Nhơn Phú A, Quận 9, TP. Thủ Đức'),
            (name: 'Salad Ức Gà Sốt Chanh Lemon', calories: 240, p: 36, c: 10, f: 5, meal: 'LUNCH', icon: Icons.eco_rounded, dist: 80, address: 'Quán Lemon, Lê Văn Việt, Quận 9, TP. Thủ Đức'),
            (name: 'Nước Ép Trái Cây Lemon', calories: 120, p: 2, c: 28, f: 0, meal: 'SNACK', icon: Icons.local_cafe_rounded, dist: 60, address: 'Quán Lemon, Lê Văn Việt, Quận 9, TP. Thủ Đức'),
            (name: 'Bánh Mì Thịt Nướng Healthy', calories: 420, p: 22, c: 48, f: 14, meal: 'BREAKFAST', icon: Icons.bakery_dining_rounded, dist: 250, address: '88 Lê Văn Việt, Phường Hiệp Phú, Quận 9, TP. Thủ Đức'),
            (name: 'Gỏi Cuốn Tôm Thịt Q9', calories: 190, p: 14, c: 22, f: 5, meal: 'SNACK', icon: Icons.tapas_rounded, dist: 600, address: '300 Lê Văn Việt, Tăng Nhơn Phú A, Quận 9, TP. Thủ Đức'),
            (name: 'Bún Mắm Miền Tây Ngã 4 Thủ Đức', calories: 480, p: 25, c: 58, f: 15, meal: 'DINNER', icon: Icons.set_meal_rounded, dist: 850, address: 'Ngã 4 Thủ Đức, Lê Văn Việt, Quận 9, TP. Thủ Đức'),
            (name: 'Chè Hạt Sen Tuyết Yến Lemon', calories: 160, p: 4, c: 34, f: 2, meal: 'SNACK', icon: Icons.icecream_rounded, dist: 70, address: 'Quán Lemon, Lê Văn Việt, Quận 9, TP. Thủ Đức'),
            (name: 'Bún Riêu Cua Đồng Lê Văn Việt', calories: 420, p: 20, c: 48, f: 14, meal: 'LUNCH', icon: Icons.soup_kitchen_rounded, dist: 720, address: '180 Lê Văn Việt, Quận 9, TP. Thủ Đức'),
            (name: 'Cháo Gà Hạt Sen Q9', calories: 290, p: 18, c: 36, f: 7, meal: 'BREAKFAST', icon: Icons.soup_kitchen_rounded, dist: 980, address: '450 Lê Văn Việt, Tăng Nhơn Phú A, Quận 9, TP. Thủ Đức'),
          ]
        : isHanoi
            ? [
                (name: 'Phở Bò Gia Truyền', calories: 450, p: 25, c: 55, f: 12, meal: 'BREAKFAST', icon: Icons.ramen_dining_rounded, dist: 220, address: '45 Hàng Bạc, Hoàn Kiếm, Hà Nội'),
                (name: 'Cơm Tấm Sườn Nướng', calories: 620, p: 32, c: 70, f: 22, meal: 'LUNCH', icon: Icons.rice_bowl_rounded, dist: 380, address: '12 Lý Thường Kiệt, Hoàn Kiếm, Hà Nội'),
                (name: 'Bún Chả Hà Nội', calories: 510, p: 28, c: 60, f: 16, meal: 'LUNCH', icon: Icons.set_meal_rounded, dist: 520, address: '24 Đinh Tiên Hoàng, Hoàn Kiếm, Hà Nội'),
                (name: 'Hủ Tiếu Nam Vang', calories: 420, p: 22, c: 50, f: 14, meal: 'DINNER', icon: Icons.soup_kitchen_rounded, dist: 750, address: '88 Tràng Thi, Hoàn Kiếm, Hà Nội'),
                (name: 'Bánh Mì Thịt Nướng', calories: 380, p: 18, c: 45, f: 12, meal: 'BREAKFAST', icon: Icons.bakery_dining_rounded, dist: 180, address: '15 Phố Cổ, Hoàn Kiếm, Hà Nội'),
                (name: 'Gỏi Cuốn Tôm Thịt', calories: 190, p: 14, c: 22, f: 5, meal: 'SNACK', icon: Icons.tapas_rounded, dist: 950, address: '30 Hai Bà Trưng, Hoàn Kiếm, Hà Nội'),
                (name: 'Mì Quảng Gà Đặc Sản', calories: 480, p: 26, c: 58, f: 15, meal: 'LUNCH', icon: Icons.dinner_dining_rounded, dist: 1400, address: '102 Bà Triệu, Hoàn Kiếm, Hà Nội'),
                (name: 'Nem Nướng Nha Trang', calories: 340, p: 20, c: 38, f: 11, meal: 'DINNER', icon: Icons.kebab_dining_rounded, dist: 2100, address: '150 Phố Huế, Hà Nội'),
                (name: 'Cơm Rang Dưa Bò', calories: 580, p: 30, c: 68, f: 18, meal: 'DINNER', icon: Icons.rice_bowl_rounded, dist: 2800, address: '200 Trần Khát Chân, Hà Nội'),
                (name: 'Chè Hạt Sen Long Nhãn', calories: 160, p: 4, c: 34, f: 2, meal: 'SNACK', icon: Icons.icecream_rounded, dist: 420, address: '18 Hàng Gai, Hoàn Kiếm, Hà Nội'),
                (name: 'Cháo Gà Hạt Sen', calories: 290, p: 18, c: 36, f: 7, meal: 'BREAKFAST', icon: Icons.soup_kitchen_rounded, dist: 1100, address: '55 Hàng Đường, Hoàn Kiếm, Hà Nội'),
                (name: 'Salad Ức Gà Sốt Chanh', calories: 260, p: 35, c: 12, f: 6, meal: 'LUNCH', icon: Icons.eco_rounded, dist: 1600, address: '72 Trần Hưng Đạo, Hà Nội'),
              ]
            : [
                (name: 'Cơm Tấm Sườn Bì Chả', calories: 620, p: 34, c: 72, f: 22, meal: 'LUNCH', icon: Icons.rice_bowl_rounded, dist: 220, address: '45 Nguyễn Trãi, Quận 1, TP.HCM'),
                (name: 'Phở Bò Nam Định', calories: 450, p: 26, c: 55, f: 12, meal: 'BREAKFAST', icon: Icons.ramen_dining_rounded, dist: 380, address: '12 Nguyễn Thị Minh Khai, Quận 1, TP.HCM'),
                (name: 'Hủ Tiếu Nam Vang Thành Đạt', calories: 510, p: 28, c: 60, f: 16, meal: 'LUNCH', icon: Icons.soup_kitchen_rounded, dist: 520, address: '34 Cô Giang, Quận 1, TP.HCM'),
                (name: 'Bánh Mì Huỳnh Hoa', calories: 540, p: 24, c: 52, f: 20, meal: 'BREAKFAST', icon: Icons.bakery_dining_rounded, dist: 180, address: '26 Lê Thị Riêng, Quận 1, TP.HCM'),
                (name: 'Gỏi Cuốn Tôm Thịt', calories: 190, p: 14, c: 22, f: 5, meal: 'SNACK', icon: Icons.tapas_rounded, dist: 420, address: '15 Phạm Ngọc Thạch, Quận 3, TP.HCM'),
                (name: 'Bún Mắm Miền Tây', calories: 480, p: 25, c: 58, f: 15, meal: 'DINNER', icon: Icons.set_meal_rounded, dist: 750, address: '88 Nguyễn Tri Phương, Quận 10, TP.HCM'),
                (name: 'Lẩu Mắm Sài Gòn', calories: 580, p: 32, c: 60, f: 22, meal: 'DINNER', icon: Icons.dinner_dining_rounded, dist: 1200, address: '102 Lý Chính Thắng, Quận 3, TP.HCM'),
                (name: 'Bún Riêu Cua Đồng', calories: 420, p: 20, c: 48, f: 14, meal: 'LUNCH', icon: Icons.soup_kitchen_rounded, dist: 950, address: '55 Võ Văn Tần, Quận 3, TP.HCM'),
                (name: 'Chè Thái Sài Gòn', calories: 220, p: 4, c: 42, f: 6, meal: 'SNACK', icon: Icons.icecream_rounded, dist: 600, address: '18 Nguyễn Tri Phương, Quận 10, TP.HCM'),
                (name: 'Salad Ức Gà Sốt Chanh', calories: 260, p: 35, c: 12, f: 6, meal: 'LUNCH', icon: Icons.eco_rounded, dist: 1400, address: '72 Lê Thánh Tôn, Quận 1, TP.HCM'),
                (name: 'Bánh Xèo Miền Tây', calories: 460, p: 22, c: 50, f: 18, meal: 'DINNER', icon: Icons.kebab_dining_rounded, dist: 1800, address: '150 Đinh Tiên Hoàng, Quận 1, TP.HCM'),
                (name: 'Cháo Lòng Đêm', calories: 380, p: 24, c: 40, f: 14, meal: 'DINNER', icon: Icons.ramen_dining_rounded, dist: 2100, address: '200 Hai Bà Trưng, Quận 1, TP.HCM'),
              ];
  ...
  void _showVenueDishesModal(MapFoodPin venuePin) {
    final venueDishes = _allPins.where((p) => (p.latitude - venuePin.latitude).abs() < 0.005).toList();
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, idx) {
                        ...
                        return Container(
                          ...
                          child: Row(
                            children: [
                              Icon(dish.icon, color: AppColors.primary, size: 24),
  ...
  void _showFavoritesModal() {
    final favList = _allPins.where((p) => _favoritePinIds.contains(p.id)).toList();
            ...
            children: [
              ...
              InkWell(
                ...
                child: const Padding(
                  ...
                  child: Icon(Icons.gps_fixed_rounded, color: AppColors.primary, size: 20),
                ),
              ),
            ],
          ),
        ...
        children: [
          ...
          ActionChip(
            ...
            label: Text(
              ...
              style: GoogleFonts.beVietnamPro(fontSize: 12, fontWeight: FontWeight.w700, color: Colors.red.shade800),
            ),
          ...
          ActionChip(
            ...
            label: Text(
              'Món tại quán',
              style: GoogleFonts.beVietnamPro(fontSize: 12, fontWeight: FontWeight.w700, color: AppColors.primary),
            ),
